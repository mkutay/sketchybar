...
# should be used with "cool-wallpapers/Bridge.jpg"
# "apple-colors-big-4k.png"
# "cat-waves.png"
# "eyes.png"
# Street.jpg
# spooky_spill.jpg
# mandelbrot_full_lavender.png
# japanese-street.png
...
export mem_color="$catppuccin_mocha_yellow"
export cpu_color="$catppuccin_mocha_green"
export ssd_color="$catppuccin_mocha_teal"
export temp_color="$catppuccin_mocha_sky"

export music_control_back_color="$catppuccin_mocha_sapphire"
...
export no_music_color="$catppuccin_mocha_subtext0"